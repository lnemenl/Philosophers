...
/*   Updated: 2024/12/13 11:52:37 by rkhakimu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philosophers.h"

static int initialize_simulation_data(t_shared *shared, int argc, char **argv, int *flags)
{
...
static int allocate_and_init_resources(t_shared *shared, t_thread_data *data, int *flags)
{
...
static int launch_simulation_threads(t_shared *shared, t_thread_data *data, int *flags)
{
